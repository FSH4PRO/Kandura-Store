...
class DesignService
{
    ...
    {
        $design = DB::transaction(function () use ($data, $customer) {
        ...
        \App\Models\Admin::query()->get()->each(
            fn (\App\Models\Admin $admin) => $admin->notify(new \App\Notifications\Admin\AdminDesignCreatedNotification($design))
        );
