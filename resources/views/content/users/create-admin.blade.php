      ...
      <div class="card">
        <div class="card-body">
          <form action="{{ route('admins.store') }}" method="POST">
            ...
            {{-- Name EN --}}
            <div class="mb-3">
              <label class="form-label">{{ __('admins.form.name_en') }} *</label>
            ...
            {{-- Name AR --}}
            <div class="mb-3">
              <label class="form-label">{{ __('admins.form.name_ar') }}</label>
            ...
            {{-- Email --}}
            <div class="mb-3">
              <label class="form-label">{{ __('admins.form.email') }} *</label>
            ...
            {{-- Password --}}
            <div class="mb-3">
              <label class="form-label">{{ __('admins.form.password') }} *</label>
            ...
            <div class="mb-4">
              <label class="form-label">{{ __('admins.form.password_confirmation') }} *</label>
              ...
              <select name="roles[]" class="form-select @error('roles') is-invalid @enderror" multiple>
                @foreach ($roles as $role)
                  <option value="{{ $role }}"
                    ...
                    {{-- نحاول نترجم، لو ما في ترجمة نظهر الاسم كما هو --}}
