      ...
      <div class="card h-100">
        <div class="card-body">
          ...
          <div class="card-info mt-3">
            ...
            <h4 class="mb-0">{{ number_format($totalWalletBalance, 2) }} {{ config('app.currency') }}</h4>
    ...
    <div class="col-xl-3 col-md-6 col-12 mb-4">
      <div class="card h-100">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-start">
            <div class="avatar flex-shrink-0">
              <div class="avatar-initial bg-label-brand rounded">
                <i class="bx bx-planet bx-sm"></i>
              </div>
            </div>
            <div class="dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end">
                <a class="dropdown-item"
                  href="{{ route('admin.designs.index') }}">{{ __('dashboard.actions.view_all') }}</a>
              </div>
            </div>
          </div>
          <div class="card-info mt-3">
            <h6 class="mb-1">{{ __('dashboard.metrics.design_catalog') }}</h6>
            <h4 class="mb-0">{{ number_format($totalDesigns) }}</h4>
            <small class="fw-medium" style="color:#97742c;">
              {{ __('dashboard.metrics.designs_this_month', ['count' => $designsThisMonth]) }}
            </small>
          </div>
        </div>
      </div>
